...
def custom_openapi():
    ...
    openapi_schema = get_openapi(
        title="WorkForce 360 API",
        version="2.0.0",
        description=(
            "🚀 WorkForce 360 is a comprehensive platform for managing workers, "
            "contracts, and job assignments.\n\n"
            "**Authentication:** All secured endpoints require JWT Bearer tokens."
        ),
        routes=app.routes,
    )

    # 🧩 Add your company info, servers, and contact
    openapi_schema["info"]["contact"] = {
        "name": "Pavi (Software Engineer)",
        "email": "pavi@company.com",
    ...
    openapi_schema["servers"] = [
        {"url": "https://api.company.com/v2", "description": "Production"},
        {"url": "https://staging.company.com/v2", "description": "Staging"},
    ]
