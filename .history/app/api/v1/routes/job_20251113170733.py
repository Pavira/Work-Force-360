...
@router.get("/get_job_postings/{companyId}", status_code=status.HTTP_200_CREATED)
...
@router.get("/get_job_detail/{jobId}", status_code=status.HTTP_200_CREATED)
...
# ------------------------# Get job By userId ------------------------
@router.get("/get_jobs/{userId}", status_code=status.HTTP_200_CREATED)
...
@router.get("/get_work_details/{jobId}", status_code=status.HTTP_200_CREATED)
