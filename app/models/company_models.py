...
# Document Types: GST Certificate(GST), Company Registration Certificate(CRC), PAN Card/ AADHAR - (IDP), logo - (LOGO)., Company photos - (CPHOTO)
# Status: draft, unapproved, approved
